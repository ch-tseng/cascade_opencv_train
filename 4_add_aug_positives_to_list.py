...
aug_positives = "H:\\working\\cascade_indoor_face\\cascade_training\\aug_positives"
positives_path = "H:\\working\\cascade_indoor_face\\cascade_training\\positives"
positiveDesc_file = os.path.join(positives_path, "positives.info")
